...
(9,'Migration batch is serialized by atomic guard',lambda:has('includes/class-spd-plugin.php',"acquire_lock( 'migration_batch'") and has('includes/class-spd-plugin.php','before_migration_batch')),
...
(37,'Media upload has atomic throttle',lambda:has('includes/class-spd-plugin.php',"consume_rate_limit( 'media_upload_'")),
