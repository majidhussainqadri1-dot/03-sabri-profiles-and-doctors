...
require('Version: 1.2.0-rc13' in main and "define( 'SPD_VERSION', '1.2.0-rc13' )" in main, 'rc13 source identity missing')
...
print('Third fresh twenty-round sequential corrective invariants passed.')
