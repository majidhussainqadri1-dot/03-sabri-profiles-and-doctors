...
check(1, 'Release identity', "Version: 1.2.0-rc3" in main and "SPD_CONTRACT_VERSION', '1.4.0'" in main and 'FUTURE-SUPERSET-18' in main and '80-ROUND-CORRECTIVE-REVIEW' in main and 'THIRD-TEN-ROUND-CORRECTIVE-REVIEW' in main, '1.2.0-rc3, contract 1.4.0, future plan identity and corrective review markers are aligned')
...
check(39, 'Package identity', 'Stable tag: 1.2.0-rc3' in readme and "SPD_DB_VERSION', '1.2.0'" in main and "SPD_CONTRACT_VERSION', '1.4.0'" in main, 'software/contract/schema identities are explicit for rc3')
