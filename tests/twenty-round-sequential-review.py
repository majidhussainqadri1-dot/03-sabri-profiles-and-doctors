...
if "Version: 1.2.0-rc11" not in bootstrap or "define( 'SPD_VERSION', '1.2.0-rc11' );" not in bootstrap:
    raise AssertionError("rc11 corrective release identity is missing")
...
# Internal user identifiers are needed by SQL predicates but must not be emitted as export field names.
...
require(".github/workflows/future-superset-18.yml", "tests/twenty-round-sequential-review.py", "1.2.0-rc11", "file03-future-superset-18-1.2.0-rc11")
require("TWENTY-ROUND-SEQUENTIAL-REVIEW-2026-08-12.md", "Defect-bearing rounds", "07, 08, 11, 16", "1.2.0-rc11")

print("File 03 twenty-round sequential corrective invariants: PASS")
