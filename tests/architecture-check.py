...
required=[
 'SPD_VERSION',"'1.2.0-rc2'",'SPD_DB_VERSION',"'1.2.0'",'SPD_CONTRACT_VERSION',"'1.4.0'",'SPD_PLAN_VERSION','FUTURE-SUPERSET-18','80-ROUND-CORRECTIVE-REVIEW',
...
print(f'Architecture checks passed ({len(php_files)} PHP files, including the 80-round corrective future superset).')
