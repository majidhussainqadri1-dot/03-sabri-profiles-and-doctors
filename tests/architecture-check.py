...
required=[
 'SPD_VERSION',"'1.2.0-rc3'",'SPD_DB_VERSION',"'1.2.0'",'SPD_CONTRACT_VERSION',"'1.4.0'",'SPD_PLAN_VERSION','FUTURE-SUPERSET-18','80-ROUND-CORRECTIVE-REVIEW','THIRD-TEN-ROUND-CORRECTIVE-REVIEW',
 ...
 'trait-spd-profile-professional.php','trait-spd-profile-central.php','trait-spd-frontend-future.php','class-spd-future-profile.php','class-spd-future-rest.php','class-spd-future-privacy.php',
...
if len(php_files)<42: raise SystemExit(f'Expanded future-superset modular tree unexpectedly small: {len(php_files)}')
print(f'Architecture checks passed ({len(php_files)} PHP files, including the third ten-round corrective future superset).')
