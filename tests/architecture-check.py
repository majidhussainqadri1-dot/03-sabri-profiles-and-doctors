...
required=[
 'SPD_VERSION',"'1.2.0-rc6'",'SPD_DB_VERSION',"'1.2.0'",'SPD_CONTRACT_VERSION',"'1.4.0'",'SPD_PLAN_VERSION','FUTURE-SUPERSET-18','80-ROUND-CORRECTIVE-REVIEW','THIRD-TEN-ROUND-CORRECTIVE-REVIEW','FOURTH-TEN-ROUND-CORRECTIVE-REVIEW','FIFTH-TEN-ROUND-CORRECTIVE-REVIEW','SIXTH-TEN-ROUND-CORRECTIVE-REVIEW',
 ...
 'SPD_Central_Privacy','SPD_Schema_Guard','record_queue_error','_spd_media_owner_user_id','_spd_media_purpose',
 'validate_audience_payload','spd_delegate_minor_forbidden'
]
...
print(f'Architecture checks passed ({len(php_files)} PHP files, including the sixth ten-round corrective hardening).')
