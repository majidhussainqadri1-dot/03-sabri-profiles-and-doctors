...
foreach ( array( 'profiles', 'fields', 'slugs', 'media', 'reports', 'events', 'idempotency', 'deletions', 'migration_failures', 'professional_submissions', 'profile_delegations', 'report_appeals' ) as $name ) {
	$table = $wpdb->prefix . 'spd_' . $name;
	$wpdb->query( "DROP TABLE IF EXISTS {$table}" ); // phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared
}
foreach ( array(
	'spd_page_map', 'spd_version', 'spd_db_version', 'spd_contract_version', 'spd_central_schema_version', 'spd_plan_version',
