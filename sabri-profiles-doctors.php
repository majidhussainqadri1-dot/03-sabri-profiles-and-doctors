 ...
 * Description: Founder profile, member profiles, doctor directory, verification, phone and WhatsApp contact foundation.
 * Version: 0.1.0
...
add_action( 'plugins_loaded', 'spd_start_plugin' );
