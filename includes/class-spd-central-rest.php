...
final class SPD_Central_REST {
	...
	public function personal_site( WP_REST_Request $r ) { return $this->response( SPD_Central_Profile::personal_site_dto( $r['public_id'], get_current_user_id() ), 200, ! is_user_logged_in() ); }
