...
trait SPD_Frontend_Report {
	...
	public function report() {
		...
		$result = SPD_Profile_Repository::instance()->create_report( $public_id, get_current_user_id(), wp_unslash( $_POST['reason'] ?? '' ), wp_unslash( $_POST['details'] ?? '' ) );
