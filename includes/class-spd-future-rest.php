...
final class SPD_Future_REST {
	...
	public function future_state( WP_REST_Request $r ) {
		...
		$submitted = (array) $r->get_json_params(); $allowed = array( 'professional_lifecycle', 'lifecycle_reason', 'federation_opt_in' );
